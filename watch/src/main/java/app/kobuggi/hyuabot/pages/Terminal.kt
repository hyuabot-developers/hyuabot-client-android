...
@Composable
fun Terminal(vm : MainViewModel) {
    Column{
        Text(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(id = R.string.terminal),
        ...
        Card(
            ...
            Row (
                ...
                if (vm.terminalArrival[0] < 0) {
                    ...
                    Text(
                        text = stringResource(id = R.string.remaining_time, vm.terminalArrival[0]),
                        style = MaterialTheme.typography.body1
                    )
                }
            }
