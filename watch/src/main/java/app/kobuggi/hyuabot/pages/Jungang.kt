...
@Composable
fun Jungang(vm : MainViewModel) {
    Column{
        Text(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(id = R.string.jungang_stn),
        ...
        Card(
            ...
            Row (
                ...
                if (vm.jungangArrival[0] < 0) {
                    ...
                    Text(
                        text = stringResource(id = R.string.remaining_time, vm.jungangArrival[0]),
                        style = MaterialTheme.typography.body1
                    )
                }
            }
