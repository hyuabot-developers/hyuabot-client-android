...
class MapCategoryButtonAdapter(
    private val context: Context,
    val onClickItem: (category: Int,
                      categoryKey: String) -> Unit) : RecyclerView.Adapter<MapCategoryButtonAdapter.MapCategoryButtonViewHolder>() {
