...
class ShuttleTabDormitoryFragment @Inject constructor() : Fragment() {
    ...
    override fun onCreateView(
        ...
        val shuttleStationRouteAdapter = ShuttleRouteAdapter(
            listOf(
                ShuttleRouteItemView.Route(
                    ...
                    currentStopIndex = 0,
                    labels = mapOf(
                        R.string.shuttle_tab_dormitory_out to 0,
                        R.string.shuttle_tab_shuttlecock_out to 5,
                        R.string.shuttle_tab_station to 15,
                ...
                ShuttleRouteItemView.Route(
                    ...
                    labels = mapOf(
                        ...
                        R.string.shuttle_tab_shuttlecock_out to 5,
                        R.string.shuttle_tab_station to 15,
                        R.string.shuttle_tab_terminal to 20,
                        R.string.shuttle_tab_shuttlecock_in to 30,
                        R.string.shuttle_type_dormitory to 35
                    )
                )
            ),
            ...
            listOf(
                ShuttleRouteItemView.Route(
                    ...
                    labels = mapOf(
                        ...
                        R.string.shuttle_tab_shuttlecock_out to 5,
                        R.string.shuttle_tab_station to 15,
                        R.string.shuttle_type_jungang to 18,
                        R.string.shuttle_tab_shuttlecock_in to 28,
                        R.string.shuttle_type_dormitory to 33
                    )
                )
            ),
        ...
        parentViewModel.latestShuttleResult.observe(viewLifecycleOwner) { source ->
            ...
            val shuttle = source.result.firstOrNull { it.name == "dormitory_o" } ?: return@observe
            ...
            // Update the recycler view by showing by destination or by time
    ...
    private fun updateBusAlternativeStation(data: BusAlternativeData?, forceShow: Boolean = false) {
        ...
        if (shouldShow) {
            ...
            bindBusAlternativeInfo(
                ...
                "dormitory_o",
                getString(R.string.shuttle_tab_dormitory_out),
                data
            )
        }
    }
