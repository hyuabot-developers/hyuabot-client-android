...
import app.kobuggi.hyuabot.adapter.BusTimetableCardListAdapter
import app.kobuggi.hyuabot.model.BusTimeTableItem
import java.time.LocalTime
import java.time.format.DateTimeFormatter

class BusTimetableFragment(private val timetable: List<BusTimeTableItem>) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val shuttleTimetableCardListAdapter = BusTimetableCardListAdapter(timetable, activity as Context)
